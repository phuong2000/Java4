...
public interface OrderDAO extends JpaRepository<Order, Long> {
	...
	@Query(value = "SELECT o FROM Order o WHERE o.account.username = :username AND o.productName LIKE %:keyword%")
	public Page<Order> findByUsernameAndProductNameContaining(@Param("username") String username,
