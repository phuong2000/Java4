...
public class FeedbackAdminController {
	...
	public String search(ModelMap model,
			@RequestParam(name = "username", required = false) Account username,
		...
		if (username != null && StringUtils.hasText(username.getUsername())) {
			resultPage = feedbackService.findByUsernameContaining(username.getUsername(), pageable);
