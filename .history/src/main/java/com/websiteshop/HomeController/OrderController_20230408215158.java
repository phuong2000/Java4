...
public class OrderController {
    ...
    public String searchOrdersByUsername(ModelMap model, HttpServletRequest request,
        ...
        // Tìm kiếm tài khoản Account tương ứng với username của User
        Account account = accountService.findByUsername(userDetails.getUsername());

        // Sử dụng thông tin tài khoản Account để thực hiện các thao tác khác trong ứng
        // dụng
        ...
        if (StringUtils.hasText(name)) {
            resultPage = orderService.findByAccountUsernameAndCustomerNameContaining(account, name, pageable);
