...
public class OrderController {
    ...
    public String searchOrdersByUsername(ModelMap model, HttpServletRequest request,
        ...
        if (StringUtils.hasText(name)) {
            resultPage = orderService.findByUsernameAndCustomerNameContaining(username, name, pageable);
    ...
    // @GetMapping("/view/page3")
    // public String searchOrdersByUsername(ModelMap model, HttpServletRequest
    // request,
    // @RequestParam(name = "name", required = false) String name,
    // @RequestParam("page") Optional<Integer> page,
    // @RequestParam("size") Optional<Integer> size) {
