...
public class OrderController {
    ...
    public String searchOrdersByUsername(ModelMap model, HttpServletRequest request,
        ...
        if (StringUtils.hasText(name)) {
            ...
            // get totalsize orders
            List<Order> orders = (List<Order>) orderService.findByUsername(username, pageable);
            int totalItemsOrder = orders.size();
            model.addAttribute("totalItemsOrder", totalItemsOrder);
        }
