...
public class ProductController {
    ...
    public String pin5000mAh(Model model) {
        model.addAttribute("item", pdao.findByPin5000mAh());
        return "product/list_search";
    }

    @RequestMapping("/dtdd-choi-game")
    public String game(Model model) {
        model.addAttribute("item", pdao.findByGame());
        return "product/list_search";
    }

    @RequestMapping("/dtdd-chup-anh")
    public String camera(Model model) {
        model.addAttribute("item", pdao.findByCamera());
        return "product/list_search";
    }

    @RequestMapping("/dtdd-64-GB")
    public String R32GB(Model model) {
