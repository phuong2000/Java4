...
public class ProductController {
    ...
    @RequestMapping("/product/price/10000000-20000000")
    public String price6(Model model) {
        model.addAttribute("price", pdao.findByUnitPrice(10000000, 20000000));
        return "product/findByPrice";
    }

    @RequestMapping("/product/price/20000000-50000000")
    public String price5(Model model) {
        model.addAttribute("price", pdao.findByUnitPrice(20000000, 50000000));
        return "product/findByPrice";
    }
}
