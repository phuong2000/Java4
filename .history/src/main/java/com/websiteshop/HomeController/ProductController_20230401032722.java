...
public class ProductController {
    ...
    public String game(Model model) {
        model.addAttribute("item", pdao.findByPinDiscription("game"));
        return "product/list_search";
    }

    @RequestMapping("/dtdd-chup-anh")
    public String camera(Model model) {
        model.addAttribute("item", pdao.findByPinDiscription("camera"));
        return "product/list_search";
    }
    ...
    public String Rom32GB(Model model) {
        ...
        model.addAttribute("item", pdao.findByPinDiscription("32GB"));
        return "product/list_search";
    }
    ...
    public String Rom64GB(Model model) {
        ...
        model.addAttribute("item", pdao.findByPinDiscription("64GB"));
        return "product/list_search";
    }
    ...
    public String Rom128GB(Model model) {
        ...
        model.addAttribute("item", pdao.findByPinDiscription("128GB"));
        return "product/list_search";
    }
    ...
    public String Rom256GB(Model model) {
        ...
        model.addAttribute("item", pdao.findByPinDiscription("256GB"));
        return "product/list_search";
    }
    ...
    public String Rom512GB(Model model) {
        ...
        model.addAttribute("item", pdao.findByPinDiscription("512GB"));
        return "product/list_search";
    }
