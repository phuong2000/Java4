...
public class OrderServiceImpl implements OrderService {
	...
	@Override
	public Page<Order> findByAccountUsernameAndCustomerNameContaining(Account account, String name, Pageable pageable) {
		String username = account.getUsername();
		return odao.findByAccountUsernameAndCustomerNameContaining(username, name, pageable);
	}

	@Override
	public Page<Order> findByAccountUsernameAndCustomerNameContaining(Account account, String name, Pageable pageable) {
		String username = account.getUsername();
		return orderDAO.findByAccountUsernameAndCustomerNameContaining(username, name, pageable);
	}
