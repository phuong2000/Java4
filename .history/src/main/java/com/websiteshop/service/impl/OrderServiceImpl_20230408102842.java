...
public class OrderServiceImpl implements OrderService {
	...
	@Override
	public Page<Order> findByUsernameAndCustomerNameContaining(String username, String name, Pageable pageable) {
		return orderDao.findByUser_UsernameContainingAndCustomerNameContaining(username, name, pageable);
	}
