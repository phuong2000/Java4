...
public interface OrderService {
	...
	Page<Order> findByUsername(Account account, Pageable pageable);
	...
	Page<Order> findByUsernameAndCustomerNameContaining(Account account, String name, Pageable pageable);
